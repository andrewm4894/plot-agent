"""
This is a safer version of the PlotAgentExecutionEnvironment that uses a more
strict AST scan to enforce a whitelist of allowed imports.

It also uses a more strict timeout mechanism and captures both stdout and stderr.

It also purges any old `fig` between runs.
"""
